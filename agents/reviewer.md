...
- for theory/modeling work, you load `superRA:theory-modeling` at all stages, and per its Stage-Scoped References table also load the matching planning, drift-test, or integration reference as a reviewer.
