...
**Objective:** Make Codex treat a user-invoked superRA workflow as explicit authorization for the named-agent workflow, with reviewer dispatch still mandatory, warm-agent lifecycle guidance explicit, and the Codex adapter guaranteed to load whenever `using-superRA` loads.
