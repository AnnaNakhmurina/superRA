...
| `refactor-and-integrate` | Tools for **codebase coherence** — convention fit, utility reuse, PR-friendly diffs, Project Doc Audit walk-up, minimum net diff against the host — plus drift-test quality and use of task-local Sync impact as post-sync context. Loaded by integration-phase agents. |
